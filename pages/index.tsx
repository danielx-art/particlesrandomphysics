...
const Home: NextPage = () => {
  return (
    <>
      <p className='text-1xl w-full text-center absolute'>Hit refresh</p>
      <Canvas className='h-full w-full absolute'>
        <Particles />
      </Canvas>
      <div className='text-2xl w-full text-center z-10 sticky bottom-0 p-2'>
